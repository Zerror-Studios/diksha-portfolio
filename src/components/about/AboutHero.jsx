        ...
        <>
            <div className=" about_hero w-full relative">
                ...
                <div className=" abt_hero_bg w-full h-screen center text-center bg-[#F9F7EC00]">
                    <h1 className=' abt_hero_bg_title   z-10 text-white leading-none   text-7xl' >Hello, I'm <br /> <span className='playfair-italic'>Diksha Ghanshani</span></h1>
                </div>
                <div className=" abt_hero_bg abt_desc_sec  w-full h-[50vh] center text-center bg-[#F9F7EC00] ">
                    <p className='font-semibold text-choc leading-none w-[60%] text-3xl'>From observing customer behavior in a family-run stationery shop to designing healthcare solutions and large-scale product experiences, the journey has always been driven by one belief — meaningful design begins with understanding people.</p>
                </div>
            </div>
            <div className="w-full h-screen relative bg-[#F9F7EC]">
                <div className="w-full  absolute z-10">
                    <img src="/images/aboutpage/abt_clip.svg" className='w-full ' alt="" />
                </div>

                <Image src="/images/aboutpage/abt_img.png" alt='loading' fill className=' cover' />

                <div className="container text-white w-full flex flex-col justify-between pt-44 pb-14 absolute! inset-0 z-10 text-center">
                    <h2 className='text-white text-6xl leading-14 font-thin '>Design Beyond<br /> <span className=' playfair-italic'>Screens.</span></h2>

                    <div className="w-full grid grid-cols-2 text-left gap-x-24">
