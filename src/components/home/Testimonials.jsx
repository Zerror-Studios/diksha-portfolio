            ...
            <div className="container py-24 space-y-16">
                <div className="w-full grid grid-cols-6 items-end">
                    <div className="col-span-4">
                        <h2 className='text-gray text-6xl leading-14 font-thin '>Experiences Shared<br />  <span className='text-choc playfair-italic'>By Brands.</span></h2>
                    </div>
                    <div className="col-span-2 pb-3 flex justify-end gap-x-4 ">
                        <button
                            aria-label="Previous slide"
                            disabled={isBeginning}
                            onClick={() => swiperRef.current?.slidePrev()}
                            className={`prev_button size-12 border-[#713F1E30] text-choc center rounded-full border transition-all duration-300
                            ${isBeginning
                        ...
                        <button
                            ...
                            className={`next_button size-12 border-[#713F1E30] text-choc center rounded-full border transition-all duration-300
                                ${isEnd
                                    ? "opacity-40 cursor-not-allowed!"
                                    : "group hover:bg-[#713F1E] hover:text-white! hover:border-[#713F1E]"
                                }`}
                ...
                <div className="">
                    ...
                    >
                        {testimonials.map((item) => (
                            <SwiperSlide
                                key={item.id}
                                className=" bg-[#E6DEC9]  rounded-2xl  p-8 w-[40vw]! h-96! shrink-0 text-choc font-semibold  flex!   flex-col  justify-between   "
                            >
                                {/* Top */}
