            ...
            <div className="container py-24 space-y-16">
                <div className="w-full grid grid-cols-6 items-end">
                    <div className="col-span-4">
                        <h2 className='text-gray text-6xl leading-14 font-thin '>Projects built <br /> with <span className='text-choc playfair-italic'>intention.</span></h2>
                    </div>
                ...
                <div ref={container} className="w-full space-y-5">
                    {projectsData.map((item, i) => (
                        <div key={i} className="proj_paren w-full rounded-xl aspect-video text-white relative overflow-hidden">
                            ...
                            <div className=" absolute bottom-0 p-10  z-10 w-full flex justify-between items-end">
                                <div className="space-y-5">
                                    <div className="font-semibold flex gap-x-1">
                                        <div className="size-1.5 translate-y-1.5 bg-white"></div>
                                        {item.year}
                                    </div>
                                    <h4 className='text-2xl leading-none font-semibold w-[70%]'>{item.title}</h4>
                                </div>
